...
const int EN_PIN = 46;  // Left and right side motors - Enable Pin
...
const int MOT_EN = 153; // Motor Enable - 204/255 = 80% duty cycle
const int MOT_DA = 0;   // Motor Disable

const int rightDelay = 625;   // Time take to turn right 90°
const int leftDelay = 700;    // Time take to turn left 90°
